export const subjectTopics: Record<string, string[]> = {
  Mathematics: ['Algebra', 'Simultaneous equations', 'Geometry', 'Trigonometry', 'Statistics', 'Graphs', 'Probability'],
  Maths: ['Algebra', 'Simultaneous equations', 'Geometry', 'Trigonometry', 'Statistics', 'Graphs', 'Probability'],
  'English Language': ['Essay writing', 'Comprehension', 'Grammar', 'Summary writing', 'Poetry', 'Literature analysis'],
  ...
  Accounts: ['Ledger accounts', 'Trial balance', 'Bank reconciliation', 'Final accounts', 'Control accounts', 'Depreciation'],
  'Computer Science': ['Algorithms', 'Programming logic', 'Databases', 'Networks', 'Computer systems', 'Data representation'],
