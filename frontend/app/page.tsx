...
const subjects = ['Maths', 'English', 'Science', 'History', 'Geography', 'Commerce', 'Shona']
...
export default function Home() {
  return (
    <main className="min-h-screen bg-bg-primary text-text-primary">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl font-display font-semibold leading-tight tracking-tight text-text-primary md:text-6xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link href="#signup" className="inline-flex items-center justify-center rounded-full bg-accent-primary px-6 py-3 text-sm font-semibold text-white shadow-soft transition hover:bg-[#b55a26]">
                Start learning for free
              </Link>
              <Link href="#features" className="inline-flex items-center justify-center rounded-full border border-accent-primary px-6 py-3 text-sm font-semibold text-accent-primary transition hover:bg-[#F8E8D9]">
                Explore features
              </Link>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-[32px] border border-[rgba(28,25,23,0.08)] bg-bg-secondary p-8 shadow-soft">
      ...
      <section id="features" className="border-t border-[rgba(28,25,23,0.08)] bg-bg-secondary py-16">
        <div className="mx-auto max-w-6xl px-6 md:px-10">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-4 text-4xl font-display font-semibold text-text-primary">Built to support every part of your study journey</h2>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:px-10">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-display font-semibold text-text-primary">A strong foundation across key subjects</h2>
      ...
      <section className="border-t border-[rgba(28,25,23,0.08)] bg-bg-secondary py-16">
        <div className="mx-auto max-w-6xl px-6 md:px-10">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-4xl font-display font-semibold text-text-primary">Free tier plus a smart Pro upgrade</h2>
          </div>
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-3xl border border-[rgba(28,25,23,0.08)] bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-5xl font-display font-semibold text-text-primary">$0</p>
            ...
            <div className="rounded-3xl border border-accent-primary bg-[#FFF0E6] p-8 shadow-soft">
              ...
              <p className="mt-4 text-5xl font-display font-semibold text-text-primary">$4.99<span className="text-base font-normal"> / month</span></p>
              <ul className="mt-6 space-y-3 text-text-secondary">
      ...
      <section id="signup" className="mx-auto max-w-6xl px-6 py-16 md:px-10">
        <div className="rounded-[32px] border border-[rgba(28,25,23,0.08)] bg-white p-10 text-center shadow-soft">
          <h2 className="text-3xl font-display font-semibold text-text-primary">Ready to light up your learning?</h2>
          <p className="mt-4 text-text-secondary">Sign up quickly and begin your first study session with Mwenje.</p>
          <div className="mt-8 flex justify-center">
            <Link href="/" className="inline-flex items-center justify-center rounded-full bg-accent-primary px-8 py-4 text-sm font-semibold text-white shadow-soft hover:bg-[#b55a26]">
              Start for free
            </Link>
          </div>
        </div>
